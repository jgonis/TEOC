 ...
 * and marks the current instruction. Also displays the current program
 * file/directory name and enables the selection of a new file/directory. If a
 * new file/directory is selected, the gui will notify its listeners on the
 * change. This GUI should disable external inputs to the program itself. The
 * instruction codes constants can be found in
 * Hack.VirtualMachine.HVMInstructionSet .
 */
public interface VMProgramGUI extends InteractiveComputerPartGUI {
	 ...
	 * creating a ProgramEvent (with the new event type and program's
	 * file/directory name) and sending it using the programChanged method to
	 * all the listeners.
	 */
	 ...
	 */
	public void setContents(VMEmulatorInstruction[] instructions, int instructionsLength);
