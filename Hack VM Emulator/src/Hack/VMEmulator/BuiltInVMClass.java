...
/**
 * A BuiltIn VM Class. The base class for all classes which are implemented in
 * java. All methods in decendents of this class represent functions and
...
public abstract class BuiltInVMClass {
	...
	public static final short SCREEN_END_ADDRESS = Definitions.SCREEN_END_ADDRESS - 1; // Definitions.SCREEN_END_ADDRESS
																						// is
																						// actually
																						// one
																						// past...
	...
	protected static short callFunction(String functionName, int param) throws TerminateVMProgramThrowable {
		return callFunction(functionName, new short[] { (short) param });
	}

	protected static short callFunction(String functionName, int param1, int param2)
			throws TerminateVMProgramThrowable {
		return callFunction(functionName, new short[] { (short) param1, (short) param2 });
	}

	protected static short callFunction(String functionName, int param1, int param2, int param3)
			throws TerminateVMProgramThrowable {
		return callFunction(functionName, new short[] { (short) param1, (short) param2, (short) param3 });
	}

	protected static short callFunction(String functionName, int param1, int param2, int param3, int param4)
			throws TerminateVMProgramThrowable {
		return callFunction(functionName,
				new short[] { (short) param1, (short) param2, (short) param3, (short) param4 });
	}
