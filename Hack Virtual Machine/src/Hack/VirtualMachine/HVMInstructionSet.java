...
public class HVMInstructionSet {
	...
	// The actual segments should be numbered from 0 onwards, so they can be
	...
	/**
	 * Returns the code of the given instruction string. If not exists, returns
	 * UNKNOWN_INSTRUCTION.
	 */
	...
	/**
	 * Returns the hardware pointer name of the given segment VM string. If not
	 * exists, returns null.
	 */
