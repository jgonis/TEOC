...
public class Format {
	...
	/**
	 * Translates a given string to a short according to the current format. The
	 * format can be decimal, hexadecimal or binary.
	 */
	...
	/**
	 * Translates a given short to a string according to the current format. The
	 * format can be decimal, hexadecimal or binary.
	 */
