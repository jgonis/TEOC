...
public class Connection {
	...
	// The number of the gate's pin (input, internal or output, according to the
	// type)
	...
	// The bit indice of the parts's sub node (index 0 is low bit and index 1 is
	// high bit)
	private byte[] partSubBus;

	// The bit indice of the gate's sub node (index 0 is low bit and index 1 is
	// high bit)
	 ...
	 */
	public Connection(byte type, int gatePinNumber, int partNumber, String partPinName, byte[] gateSubBus,
			byte[] partSubBus) {
		this.type = type;
