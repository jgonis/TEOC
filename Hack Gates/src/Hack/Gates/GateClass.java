...
public abstract class GateClass {
	...
	/**
	 * Returns the GateClass associated with the given gate name. If
	 * containsPath is true, the gate name is assumed to contain the full path
	 * of the hdl file. If doesn't contain path, looks for the hdl file
	 * according to the directory hierarchy. If the GateClass doesn't exist yet,
	 * creates the GateClass by parsing the hdl file.
	 */
	...
	// returns it.
	private static GateClass readHDL(HDLTokenizer input, String gateName) throws HDLException {
	...
	/**
	 * Returns the PinInfo according to the given pin name. If doesn't exist,
	 * return null.
	 */
	...
	/**
	 * Returns the type of the given pinName. If not found, returns
	 * UNKNOWN_PIN_TYPE.
	 */
