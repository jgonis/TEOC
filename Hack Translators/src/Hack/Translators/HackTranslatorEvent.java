...
/**
 * An event for notifying a HackTranslatorEventListener on an action that should
...
public class HackTranslatorEvent extends EventObject {
	...
	/**
	 * Action code for performing the Full Compilation operation. supplied data
	 * = null
	 */
	public static final byte FULL_COMPILATION = 5;

	/**
	 * Action code for saving the dest file. supplied data = dest file name
	 * (String)
	 */
	public static final byte SAVE_DEST = 6;

	/**
	 * Action code for loading a source file. supplied data = source file name
	 * (String)
	 */
