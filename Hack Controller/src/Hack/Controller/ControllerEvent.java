...
/**
 * An event for notifying a ControllerEventListener on an action that should be
 * taken, together with a data object which is supplied with the action code.
 */
public class ControllerEvent extends EventObject {
	...
	/**
	 * Action code for performing the fast forward operation. supplied data =
	 * null
	 */
	public static final byte FAST_FORWARD = 2;

	/**
	 * Action code for changing the speed. supplied data = speed (Integer,
	 * 1..ControllerGUI.NUMBER_OF_SPEED_UNITS)
	 */
	public static final byte SPEED_CHANGE = 3;

	/**
	 * Action code for performing the stop operation. supplied data = null
	 */
	public static final byte STOP = 4;

	/**
	 * Action code for changing the breakpoints. supplied data = Vector of
	 * Breakpoint objects
	 */
	public static final byte BREAKPOINTS_CHANGE = 5;

	/**
	 * Action code for changing the script file. supplied data = script file
	 * (File)
	 */
	public static final byte SCRIPT_CHANGE = 6;

	/**
	 * Action code for performing the rewind operation. supplied data = null
	 */
	public static final byte REWIND = 9;

	/**
	 * Action code for changing the animation mode. supplied data = animation
	 * code (Integer, out of the animation constants in HackController)
	 */
	public static final byte ANIMATION_MODE_CHANGE = 10;

	/**
	 * Action code for changing the numeric format. supplied data = format code
	 * (Integer, out of the format constants in HackController)
	 */
	public static final byte NUMERIC_FORMAT_CHANGE = 11;

	/**
	 * Action code for changing the additional display. supplied data =
	 * additional display code (Integer, out of the additional display constants
	 * in HackController)
	 */
	public static final byte ADDITIONAL_DISPLAY_CHANGE = 12;

	/**
	 * Action code for showing the controller. supplied data = null
	 */
	public static final byte SHOW_CONTROLLER = 13;

	/**
	 * Action code for hiding the controller. supplied data = null
	 */
	...
	/**
	 * Action code for halting the simulator program. supplied data = null
	 */
	public static final byte HALT_PROGRAM = 21;

	/**
	 * Action code for continuing the simulator program. supplied data = null
	 */
	...
	/**
	 * Action code for displaying an error message in the controller status
	 * line. supplied data = error message (String)
	 */
	public static final byte DISPLAY_ERROR_MESSAGE = 26;

	/**
	 * Action code for requesting to load a new program. supplied data = null
	 */
	...
	/**
	 * Constructs a new Controller event with given source, the action code and
	 * the supplied data.
	 */
