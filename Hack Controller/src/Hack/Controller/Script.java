...
public class Script {
	...
	/**
	 * Constructs a new script according to the given script file. Simulator
	 * commands will be executed and variable values will be fetched and set
	 * using the given hack simulator.
	 */
	public Script(String scriptName) throws ScriptException, ControllerException {
	...
	private String[] readArgs(int maxArgs) throws ControllerException, ScriptException {
