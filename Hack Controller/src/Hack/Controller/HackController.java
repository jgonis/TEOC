 ...
 * scripting language that controlls the features of the simulators. Constructed
 * with a GUI that enables the execution control of the script.
 */
public class HackController implements ControllerEventListener, ActionListener, ProgramEventListener {
	...
	/**
	 * Animation mode: Specifies using dynamic animation - fully animates value
	 * changes
	 */
	...
	// The echo that was displayed (if any) when single step was stopped in the
	// middle.
