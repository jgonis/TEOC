 ...
 * names or constants, and a comparison operator, which may be =, >, <, <>, >=,
 * <=.
 */
public class ScriptCondition {
	...
	/**
	 * Constructs a new ScriptCondition with the given ScriptTokenizer, placed
	 * on the beginning of the condition clause. Returns the tokenizer after the
	 * condition clause.
	 */
	...
	public boolean compare(HackSimulator simulator) throws ControllerException {
		...
		} else if (!isNum0 && !isNum1) { // if = or <>, compare using string
											// comparison
			switch (comparisonOperator) {
			case EQUAL:
