...
/**
 * A Hack Application. Creates a controller to control the given given simulator
 * using the given GUI components. The createController method may be
 * overwridden by simulators that inherit the HackController.
 */
public abstract class HackApplication {

	/**
	 * Constructs a new HackApplication with the given Hack simulator, the
