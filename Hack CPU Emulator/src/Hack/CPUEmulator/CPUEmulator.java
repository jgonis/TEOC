 ...
 *
 * Recognizes the following variables: A - the address register (short) D - the
 * data register (short) PC - the program counter (short) RAM[i] - the contents
 * of the RAM at location i (short) ROM[i] - the contents of the ROM at location
 * i (short) time - the time that passed since the program started running
 * (long) - READ ONLY
 *
 * Recognizes the following commands: load <HACK file name> - loads the given
...
public class CPUEmulator extends HackSimulator {
	 ...
	 * source computer part and the error message.
	 */
	@Override
