 ...
 * from having the usual pointed memory GUI functionallity, the ROM GUI
 * displayes the current program (a .hack file name) and enables the selection
 * of a new program. If a new program is selected, the GUI will notify its
 * listeners on this change. The ROM GUI can also display its contents as an
